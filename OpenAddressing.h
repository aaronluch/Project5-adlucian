...
private:
    ...
    mutable unsigned long readCount; // Counts the reads
...
public:
    ...
    // Used in main to reset reads when needed
    void resetReadCount(){
        readCount = 0;
    }
